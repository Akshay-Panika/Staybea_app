...
class YourFinancialScreen extends StatefulWidget {
  const YourFinancialScreen({super.key});

  @override
  State<YourFinancialScreen> createState() => _YourFinancialScreenState();
}

class _YourFinancialScreenState extends State<YourFinancialScreen> {
