...
class YourSelfieScreen extends StatefulWidget {
  const YourSelfieScreen({super.key});

  @override
  State<YourSelfieScreen> createState() => _YourSelfieScreenState();
}

class _YourSelfieScreenState extends State<YourSelfieScreen> {
