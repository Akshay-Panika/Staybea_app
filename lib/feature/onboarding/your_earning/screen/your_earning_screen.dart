...
class YourEarningScreen extends StatefulWidget {
  const YourEarningScreen({super.key});

  @override
  State<YourEarningScreen> createState() => _YourEarningScreenState();
}

class _YourEarningScreenState extends State<YourEarningScreen> {
  // Selections
