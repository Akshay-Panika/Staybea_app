...
// your_education_screen.dart

import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:staybea_app/core/utils/app_size.dart';
import 'package:staybea_app/core/widget/app_expandable_field.dart';
import 'package:staybea_app/core/widget/app_input_field.dart';
import '../bloc/your_education/your_education_bloc.dart';
import '../bloc/your_education/your_education_event.dart';
import '../bloc/your_education/your_education_state.dart';
import '../repository/your_education_repository.dart';
import '../widget/education_shimmer.dart';

class YourEducationScreen extends StatelessWidget {
  const YourEducationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => EducationBloc(EducationRepository())
        ..add(FetchEducationEvent()),
    ...
    return BlocBuilder<EducationBloc, EducationState>(
      builder: (context, state) {
        ...
        if (state is EducationLoaded) {
          final educationData = state.response.data.first;
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Education Dropdown from API
                AppExpandableField(
                  label: "Your highest education",
                  hint: 'Your education',
                  value: state.selectedEducation,
                  isOpen: _showEducation,
                  onTap: () {
                    setState(() {
                      _showEducation = !_showEducation;
                  ...
                  items: educationData.educations, // ← from API
                  onSelect: (val) {
                    context
                        .read<EducationBloc>()
                        .add(SelectEducationEvent(val));
                    setState(() {
                      _showEducation = false;
                    });
                  },
                ...
                // College input (local, no API needed)
                AppInputField(
                  label: 'College',
                  controller: _collegeController,
                  hint: 'College you attended',
