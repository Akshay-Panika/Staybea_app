...
class YourYourselfScreen extends StatefulWidget {
  const YourYourselfScreen({super.key});

  @override
  State<YourYourselfScreen> createState() => _YourYourselfScreenState();
}

class _YourYourselfScreenState extends State<YourYourselfScreen> {
